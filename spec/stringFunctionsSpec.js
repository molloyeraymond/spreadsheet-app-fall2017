describe("String functions", function() {
  ...
  it("returns the position of the beginning of the first occurance of findText within the text starting at numChars of the text", function() {
    expect(find("M","Miriam McGovern")).toBe(0);
  });
